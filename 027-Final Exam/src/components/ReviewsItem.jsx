...
export default function ReviewsItem({name, location, rate, descr, links}) {
  ...
  return (
    <div className="tile">
      ...
      <div className="bottom-links">
          <ul>
            <li><Link to={links.facebook} target="_blank" title="facebook">
            ...
            <li><Link to={links.twitter} target="_blank" title="twitter">
            ...
            <li><Link to={links.linkedin} target="_blank" title="linkedin">
                <svg width="20.000000" height="20.000000" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <defs/>
      ...
      <div className="tile-body">
        <div>
          <div className="tile-rate">
            <ul>
              {stars}
            </ul>
          </div>
          <div className="user-descr">{descr}</div>
        </div>
      </div>
    </div>
  )
